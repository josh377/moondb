...
urlpatterns = [
	...
	url(r'^climbs/(?P<slug>[-\w]+)/videos/(?P<videoid>\d+)/$', views.video_delete, name='video_delete'),
	url(r'^climbs/(?P<slug>[-\w]+)/videos/(?P<videoid>\d+)/confirm/$', views.video_delete_confirm, name='video_delete_confirm'),
